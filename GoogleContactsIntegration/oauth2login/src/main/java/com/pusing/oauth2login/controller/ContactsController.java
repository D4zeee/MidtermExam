package com.pusing.oauth2login.controller;
...
import com.pusing.oauth2login.dto.UpdateContactRequest; // Import the DTO

import com.pusing.oauth2login.service.GoogleContactsService;
